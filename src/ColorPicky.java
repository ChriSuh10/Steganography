/**
 *  Inspired by https://stackoverflow.com/questions/1590831/safely-casting-long-to-int-in-java
 *  used for testing
 */
...
public class ColorPicky {
    ...
    public class TestPane extends JPanel {
        ...
        public TestPane() {
            ...
            label = new JLabel();
            try {
                img = ImageIO.read(new File("data/coutinho2.png"));
...
/*            fields.add(red);
            ...
            label.addMouseMotionListener(new MouseAdapter() {
                ...
                public void mouseMoved(MouseEvent e) {
                    ...
                    rgb.setText(Integer.toBinaryString(packedInt) + "");
                    x.setText(e.getX() + "");
                    y.setText(e.getY() + "");
                }
            });
